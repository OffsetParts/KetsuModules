...
let chaptersAPI = await core.fetch(`https://api.comick.io/comic/${hid}/chapters?limit=1000&lang=en`, {headers: {"Referer": "https://comick.io/"}});
...
let sortedArray : any = shared.filterChaptersByPreferredGroup(chaptersArray, ['asurascans', 'Official', 'flamecomics']).map(entry => {
