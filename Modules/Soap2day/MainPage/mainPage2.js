...
var emptyHeaders = [new KeyValue('Referer', 'https://ww25.soap2day.day/')];
...
let MainPageObject = new MainPage(new ModuleRequest(nextRequest, 'get', emptyHeaders, null), new Extra([new Commands('', emptyKeyValue)], extraInfo), new JavascriptConfig(true, false, ''), output);
